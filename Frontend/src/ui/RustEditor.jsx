...
function RustEditor() {
  ...
  const [code, setCode] = useState(() => {
    return (
      sessionStorage.getItem("rustCode") ||
      `fn main() {
  ...
  useEffect(() => {
    sessionStorage.setItem("rustCode", code);
  }, [code]);

  useEffect(() => {
    return () => {
      sessionStorage.removeItem("rustCode");
    };
  }, []);
  ...
  return (
    <Container $toggle={toggle}>
      <Header onClick={() => handleIcon("/home")}>Rust Editor</Header>
