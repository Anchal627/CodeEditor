...
function RubyEditor() {
  ...
  const [code, setCode] = useState(() => {
    return sessionStorage.getItem("rubyCode") || `puts "Hello, World!"`;
  });
  ...
  useEffect(() => {
    sessionStorage.setItem("rubyCode", code);
  }, [code]);

  useEffect(() => {
    return () => {
      sessionStorage.removeItem("rubyCode");
    };
  }, []);
  ...
  return (
    <Container $toggle={toggle}>
      <Header onClick={() => handleIcon("/home")}>Ruby Editor</Header>
