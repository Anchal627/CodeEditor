...
function JavaEditor() {
  ...
  const [code, setCode] = useState(() => {
    return (
      sessionStorage.getItem("javaCode") ||
      `public class Main {
  ...
  useEffect(() => {
    sessionStorage.setItem("javaCode", code);
  }, [code]);

  useEffect(() => {
    return () => {
      sessionStorage.removeItem("javaCode");
    };
  }, []);
  ...
  return (
    <Container $toggle={toggle}>
      <Header onClick={() => handleIcon("/home")}>Java Editor</Header>
