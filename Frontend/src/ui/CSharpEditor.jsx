...
function CSharpEditor() {
  ...
  const [code, setCode] = useState(() => {
    return (
      sessionStorage.getItem("csharpCode") ||
      `using System;
...
public class Program {
  ...
  useEffect(() => {
    return () => {
      sessionStorage.removeItem("csharpCode");
    };
  }, []);
      ...
      <MainSection>
        ...
        <EditorSection>
          <FileName toggle={toggle}>
            <h3>main.cs</h3>
            <div style={{ display: "flex", textAlign: "center", gap: "6px" }}>
