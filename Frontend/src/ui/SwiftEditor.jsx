...
function SwiftEditor() {
  ...
  const [code, setCode] = useState(() => {
    return sessionStorage.getItem("swiftCode") || `print("Hello, World!")`;
  });
  ...
  useEffect(() => {
    sessionStorage.setItem("swiftCode", code);
  }, [code]);

  useEffect(() => {
    return () => {
      sessionStorage.removeItem("swiftCode");
    };
  }, []);
  ...
  return (
    <Container $toggle={toggle}>
      <Header onClick={() => handleIcon("/home")}>Swift Editor</Header>
